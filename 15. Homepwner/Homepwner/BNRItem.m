...
- (id)initWithCoder:(NSCoder *)decoder
{
    ...
    if (self) {
        ...
        thumbnailData = [decoder decodeObjectForKey:@"thumbnailData"];
    }
    return self;
}
- (void)dealloc
...
- (void)setThumbnailDataFromImage:(UIImage *)image
{
    ...
    // Create a bitmap image context: YES it is opaque, third argument specifies the 
    // scale of the image: 2.0 for retina display, 1.0 for non-retina. 0.0 
    // means use whatever the device uses
